...
CREATE POLICY IF NOT EXISTS "Authenticated users can read partner_withdrawals"
  ON partner_withdrawals FOR SELECT TO authenticated USING (true);
CREATE POLICY IF NOT EXISTS "Authenticated users can insert partner_withdrawals"
  ON partner_withdrawals FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Authenticated users can delete partner_withdrawals"
